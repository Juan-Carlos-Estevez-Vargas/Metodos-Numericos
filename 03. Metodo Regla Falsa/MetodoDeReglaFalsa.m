...
% función y llamar la función 'ReglaFalsa' la cuál se encarga de calcular la
% raiz.
% ------------------------------------------------------------------------
...
% Llamado al método de 'ReglaFalsa' el cual calcula las raices de la función.
% -----------------------------------------------------------------------
